...
[<img src="/media/AppIcons/REGSHOTXSixFourANSI-Square44x44Logo.scale-100.png" align="left" alt="R Studio logo"  />](/media/AppIcons/REGSHOTXSixFourANSI-Square44x44Logo.scale-100.png) RegShot is an open source tool that consists of a simple gui tool for creating and comparing registry snapshots.
