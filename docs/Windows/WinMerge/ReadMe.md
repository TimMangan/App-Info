# App-Info Document WinMerge

<div>

<img src="/media/AppIcons/WINMERGEU-256.png" align="left" height="256" alt="WinMerge logo"  /> Differencing tool.  
...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | Winmerge.org |
| Application Name| Winmerge |
| Application Version | 2.16.14 (released 2021/08, not latest version available)|
| Vendor/App Website| https://winmerge.org/downloads/?lang=en |
...
File and registry configuration data exists, but are generally not of interest for pre-configuration.
