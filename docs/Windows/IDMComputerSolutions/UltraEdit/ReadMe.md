# App-Info Document UltraEdit

<div>

<img src="/media/AppIcons/UEDITSixFour-256.png" align="left" height="256" alt="UltraEdit logo"  /> UltraEdit is an editing tool that understands a lot of formats.  It is a licensed product.
...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | IDM Computer Solutions |
| Application Name| UltraEdit |
| Application Version | 28.10 (released 2021/08, newer versions available)|
| Vendor/App Website| https://www.ultraedit.com/downloads/ultraedit-download/ |
...
`Note`: You must now sign up to get a free 30 day trial. The vendor is known to have enterprise licensing.
