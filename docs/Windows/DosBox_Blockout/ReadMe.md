...
|----|
| ![badge](https://img.shields.io/badge/16Bit-Yes-green?style=for-the-badge) for app. |
| ![badge](https://img.shields.io/badge/x86-Yes-green?style=for-the-badge) for DosBox. |
...
| ![badge](https://img.shields.io/badge/File-Yes-green?style=for-the-badge) See `Note 1` |
...
`Note 1`: Edit the autoexec.bat file from DosBox to automatically start the target app.
