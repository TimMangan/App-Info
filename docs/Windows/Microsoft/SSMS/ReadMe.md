...
| Application Name| SMSS |
| Application Version | 18.9.2 (Not latest version). |
| Vendor/App Website| https://docs.microsoft.com/en-us/sql/ssms/download-sql-server-management-studio-ssms |
...
| App-V | ![badge](https://img.shields.io/badge/-Major%20Issues-critical?style=for-the-badge)  |
...
| MSIX | ![badge](https://img.shields.io/badge/-Major%20Issues-critical?style=for-the-badge) See `Note` |

`Note`: See the note on the Packaging-MSIX file for possible workaround.
