...
|-----|-------------------------------------------------------|
| Vendor Name | Notepad++ |
| Application Name| Notepad++ Main app |
| Application Version | 8.1.2 (released 2021/07, newer version available) |
| Vendor/App Website| https://github.com/notepad-plus-plus |
...
`Note1`: There are many 7zip packages in the release for various scenarios.
...
| [App-V](Packaging-MSIX.md) | ![badge](https://img.shields.io/badge/-Full%20Fidelity-brightgreen?style=for-the-badge) |
...
| [MSIX](Packaging-MSIX.md) | ![badge](https://img.shields.io/badge/-High%20Confidence-green?style=for-the-badge) on Win10, ![badge](https://img.shields.io/badge/-Full%20Fidelity-brightgreen?style=for-the-badge) on Win11 |
