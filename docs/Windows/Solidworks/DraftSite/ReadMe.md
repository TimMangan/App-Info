# App-Info Document Solidworks Draftsite

[<img src="/media/AppIcons/DRAFTSITE-Square44x44Logo.scale-100.png" align="left" alt="DraftSite logo"  />](/media/AppIcons/DRAFTSITE-Square44x44Logo.scale-100.png) Licensed CAD program.
...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | Solidworks, now Dassault Systems |
| Application Name| Draftsite |
| Application Version | 2017.0.0.0 (released 2017, newer versions available)|
| Vendor/App Website| https://www.draftsight.com/ |
