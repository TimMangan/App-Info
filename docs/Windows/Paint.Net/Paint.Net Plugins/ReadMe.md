# App-Info Document Paint.Net Plugin-Shape3D

This is an example of a plug-in to the Paint.Net program.  Shape3d plugin is used to create a 2d projection of a 3d object like a sphere, cylander, or cone.  This, and other such plugins, may be included in a Paint.Net repackaging effort directly, but sometimes it is fun to package up separately for delivery.
...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | Paint.Net+ |
| Application Name| PDN Plugin Shape3d |
| Application Version | 1.0 |
| Vendor/App Website| https://www.dotpdn.com |
...
| Type | Available |
|----|----|
| exe | [<img src="/media/Yes.png" alt="Yes" />](/media/Yes.png) See `Note1` |
...
`Note1`: While installers are possible, most of these plugins are just a dll to be copied into a specific folder.
