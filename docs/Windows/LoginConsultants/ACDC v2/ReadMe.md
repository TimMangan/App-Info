...
<img src="/media/AppIcons/ACE-256.png" align="left" height="100" alt="ACDC logo"  /> ACDC Version 2 is a help-desk tool for use on end-user systems that are using Microsoft App-V Versions 5 through 5.2.  It supports local configuration of the App-V Client and troubleshooting and repair functionality for applications virtualized under App-V.  (ACDC V1 supported App-V 4.x systems).
