...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | UltraVnc |
| Application Name| UltraVnc |
| Application Version | 1.2.4.0 (released 2021/08, not latest version available)|
| Vendor/App Website| https://uvnc.com/downloads/ultravnc |
