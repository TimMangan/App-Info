# App-Info Document WinRAR
<div>

<img src="/media/AppIcons/WINRAR-256.png" align="left" Height="256" alt="WinRAR logo"  /> WinRAR is a licensed zip compression utility.  In addition to standard formats, it also bosts its own .rar format.
...
|-----|-------------------------------------------------------|
| Vendor Name | RAR Lab |
| Application Name| WinRAR |
| Application Version | 6.0.2 (released 2021/08, newer version available)|
| Vendor/App Website| https://www.rarlab.com/ |
...
The vendor has installers for other operating systems as well.
...
| MSIX | ![badge](https://img.shields.io/badge/-Mostly%20Works-yellow?style=for-the-badge) on Win10 ![badge](https://img.shields.io/badge/-Full%20Fidelity-brightgreen?style=for-the-badge) on Win 11 |
