# App-Info Document VlcPlayer

<div>

<img src="/media/AppIcons/VLC-256.png" align="left" height="256" alt="VLC logo"  /> This is a free video player app.  From the vendor:
...
| Application Name| VlcPlayer |
| Application Version | 3.0.16 (released 2021/08, newer version available)|
| Vendor/App Website| https://www.videolan.org/vlc/ |
...
`Note 1`: The vendor has a paid-for version in the Microsoft store. This version is believed to be equally functional, however without the ability to control version updates.
