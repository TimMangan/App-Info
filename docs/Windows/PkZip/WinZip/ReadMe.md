# App-Info Document WinZip

<div>

<img src="/media/AppIcons/WINZIPSixFour-256.png" align="left" height="256" alt="WinZip logo"  /> WinZip is possibly the original, but certainly the best known of the archive compression programs.  It is a licensed program.
...
`Note`: Setup Exe contains both 32 and 64 bit software, the MSI versions have separate installers. There is also an installer for Mac.
