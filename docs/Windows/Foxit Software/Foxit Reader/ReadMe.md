...
<img src="/media/AppIcons/FOXITPDFREADER-256.png" align="left" height="256" alt="Foxit Reader logo"  /> Foxit Reader is another PDF Reader program (licensed product).
...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | Foxit Software |
| Application Name| Foxit Reader |
| Application Version | 11.0.1.0 (released 2021/07, newer versions available)|
| Vendor/App Website| https://foxitsoftware.com |
