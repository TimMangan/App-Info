...
<img src="/media/AppIcons/SWRITER-256.png" align="left" height="256" alt="Libre Office logo"  /> LibreOffice is a free and powerful office suite, and a successor to OpenOffice.org (commonly known as OpenOffice).  It is used in some organizations as an alternative to Microsoft Office.
...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | LibreOffice |
| Application Name| LibreOffice |
| Application Version | 7.1.5 (released 2021/07, newer versions available)|
| Vendor/App Website| https://www.libreoffice.org |
...
| [App-V](Pakaging-AppV.md) | ![badge](https://img.shields.io/badge/-Full%20Fidelity-brightgreen?style=for-the-badge) |
