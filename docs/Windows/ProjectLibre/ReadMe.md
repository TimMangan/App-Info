...
| Category | Value |
|-----|-------------------------------------------------------|
| Vendor Name | ProjectLibre |
| Application Name| ProjectLibre |
| Application Version | 1.9.3.0 (released 2021/07, newer version available)|
| Vendor/App Website| https://www.projectlibre.com/ |
