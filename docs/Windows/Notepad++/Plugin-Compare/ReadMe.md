...
|-----|-------------------------------------------------------|
| Vendor Name | Notepad++ |
| Application Name| nP++ Plugin Compare |
| Application Version | 1.0 |
| Vendor/App Website| https://mremoteng.org |
...
|----|
| ![badge](https://img.shields.io/badge/exe-Yes-green?style=for-the-badge)  See `Note1` |
...
`Note1`: While installers are possible for Notepad++ plugins, most of these plugins are just a dll to be copied into a specific folder.
